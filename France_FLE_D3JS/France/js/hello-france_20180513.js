...
var max_longitude = d3.max(dataset, function (d) { return d.longitude });
var min_longitude = d3.min(dataset, function (d) { return d.longitude });
var max_latitude = d3.max(dataset, function (d) { return d.latitude });
var min_latitude = d3.min(dataset, function (d) { return d.latitude });

var max_population = d3.max(dataset, function (d) { return d.population });
var max_density = d3.max(dataset, function (d) { return d.density });
...
var circleAttributes = circles
                      .attr("cx", function (d) {return scaleLong(d.longitude)})
                      .attr("cy", function (d) {return scaleLat(d.latitude)})
                      .attr("r", function (d) {return scaleRadius(d.population)})
                      .style("fill", "blue")
                      .style("opacity", function (d) {return scaleOpacity(d.density)});
